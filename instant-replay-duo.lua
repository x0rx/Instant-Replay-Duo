...
function script_properties()
	...
	local p = obs.obs_properties_add_list(props, "source0", "Media Source Normal Speed", obs.OBS_COMBO_TYPE_EDITABLE, obs.OBS_COMBO_FORMAT_STRING)
	local p1 = obs.obs_properties_add_list(props, "source1", "Media Source Slow Speed", obs.OBS_COMBO_TYPE_EDITABLE, obs.OBS_COMBO_FORMAT_STRING)
